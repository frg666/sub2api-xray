...
現在の正式リリースは、上流 `v0.1.164` をベースにした `v0.1.164-xray3` です。上流機能の同期、プロキシプロトコル互換性、ランタイムのライフサイクル、アカウント権限、オンライン更新の改善については[リリースノート](docs/releases/v0.1.164-xray3_JA.md)を参照してください。
