...
現在の統合ビルドは上流 `v0.1.164` をベースにした `v0.1.164-xray2-beta1` です。最新の正式版は `v0.1.161-xray2` のままで、プロトコル、ユーザーリソース、UI、アップグレード変更はその[リリースノート](docs/releases/v0.1.161-xray2_JA.md)を参照してください。
