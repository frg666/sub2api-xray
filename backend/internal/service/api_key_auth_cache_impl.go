...
// v23 preserves private group ownership plus group long-context, model pricing
// and OpenAI Fast switch fields, and adds the official codex_models_manifest_config field.
