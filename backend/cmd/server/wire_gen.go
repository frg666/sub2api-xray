...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	userResourceService := service.ProvideUserResourceService(db, subscriptionService, billingCacheService, apiKeyAuthCacheInvalidator, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, dashboardService, groupCapacityService, userGroupRateRepository, proxyExitInfoProber, proxyLatencyCache)
	...
	adminService := service.NewAdminService(userRepository, groupRepository, adminAccountRepository, proxyRepository, apiKeyRepository, redeemCodeRepository, userGroupRateRepository, userRPMCache, billingCacheService, proxyExitInfoProber, proxyLatencyCache, apiKeyAuthCacheInvalidator, db, client, settingService, subscriptionService, userSubscriptionRepository, privacyClientFactory, openAIGatewayService, affiliateService)
