...
The current formal Xray release is [v0.1.176-xray4](https://github.com/SMOOONN/sub2api-xray/releases/tag/v0.1.176-xray4), synchronized with official `v0.1.176` and its latest corresponding `main` commits.
