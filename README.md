...
The current formal Xray release is [v0.2.0-xray4](https://github.com/smmooooonn/sub2api-xray/releases/tag/v0.2.0-xray4), synchronized with official `v0.2.0` and its latest corresponding `main` commits.
